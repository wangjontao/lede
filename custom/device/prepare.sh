...
require_grep 'label = "wan";' "$DTS" "Q30Pro-style WAN DSA port"
require_grep 'port@0 {' "$DTS" "Q30Pro WAN switch port"
require_grep 'port@1 {' "$DTS" "Q30Pro LAN1 switch port"
require_grep 'port@3 {' "$DTS" "Q30Pro LAN3 switch port"
...
require_grep 'ucidef_set_interfaces_lan_wan "lan1 lan2 lan3" wan' "$NET" "Q30Pro 1WAN plus 3LAN mapping"
